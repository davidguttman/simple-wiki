  ...
  return api.getDocument(title, (function(_this) {
    return function(err, data) {
      ...
      if (data && data.markdown) {
        ...
        return _this.state.currentMarkdown.set('This is a new page. Create it now!');
      }
    };
  })(this));
};
